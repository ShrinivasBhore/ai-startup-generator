  ...
  return (
    ...
    >
      ...
      {mobileMenuOpen && (
        ...
        >
          <a href="#features" className="text-gray-300 font-medium">
            Features
          </a>
          <a href="#pricing" className="text-gray-300 font-medium">
            Pricing
          </a>
          <a href="#faq" className="text-gray-300 font-medium">
            FAQ
          </a>
          <hr className="border-white/10 my-2" />
          <div className="flex flex-col gap-3">
            <button className="text-center py-2 text-gray-300 font-medium">
              Sign In
            </button>
            <button className="text-center py-2 bg-indigo-600 text-white rounded-xl font-medium">
              Start Free Trial
            </button>
          </div>
        </motion.div>
