...
export default function Generator() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setResult(json.plan);
      toast.success("Your startup plan has been successfully generated!");
    } catch (err: any) {
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-400">
                    Be as specific as possible about the problem you are solving
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="SaaS / Software" className="bg-zinc-900">
                        SaaS / Software
                      </option>
                      <option value="Fintech" className="bg-zinc-900">
                        Fintech
                      </option>
                      <option
                        value="Healthtech / Medtech"
                        className="bg-zinc-900"
                      >
                        Healthtech / Medtech
                      </option>
                      <option value="E-commerce" className="bg-zinc-900">
                        E-commerce
                      </option>
                      <option value="Edtech" className="bg-zinc-900">
                        Edtech
                      </option>
                      <option
                        value="Cleantech / Green Energy"
                        className="bg-zinc-900"
                      >
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 text-sm font-medium text-gray-200">
                      <Wallet className="w-4 h-4 text-rose-400" /> Initial
                      Budget
                    </label>
                    <select
                      {...register("budget")}
                    ...
                    >
                      ...
                      <option
                        value="Bootstrapped (<$10k)"
                        className="bg-zinc-900"
                      >
                        Bootstrapped (&lt;$10k)
                      </option>
                      <option
                        value="Pre-seed ($10k - $100k)"
                        className="bg-zinc-900"
                      >
                        Pre-seed ($10k - $100k)
                      </option>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 text-sm font-medium text-gray-200">
                      <Target className="w-4 h-4 text-blue-400" /> Target
                      Audience
                    </label>
                    <select
                      {...register("audience")}
                    ...
                    >
                      ...
                      <option value="B2B Enterprise" className="bg-zinc-900">
                        B2B Enterprise
                      </option>
                      <option value="B2B SMBs" className="bg-zinc-900">
                        B2B SMBs
                      </option>
                      <option value="B2C Consumers" className="bg-zinc-900">
                        B2C Consumers
                      </option>
                      <option value="B2B2C" className="bg-zinc-900">
                        B2B2C
                      </option>
                      <option
                        value="D2C Niche Community"
                        className="bg-zinc-900"
                      >
                        D2C Niche Community
                      </option>
          ...
          {isGenerating && (
            ...
            >
              ...
              <p className="text-indigo-200">
                Building your custom startup business plan.
              </p>

              <div className="mt-8 flex flex-col gap-3 w-full max-w-sm">
                <LoadingStep text="Evaluating market dynamics..." delay={0} />
                <LoadingStep
                  text="Drafting go-to-market strategy..."
                  delay={1}
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                  <h3 className="flex items-center gap-2 text-lg font-semibold text-white mb-4">
                    <ListChecks className="w-5 h-5 text-emerald-400" /> Core
                    Features
                  </h3>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                  <h3 className="flex items-center gap-2 text-lg font-semibold text-white mb-4">
                    <Crosshair className="w-5 h-5 text-rose-400" /> Marketing
                    Strategy
                  </h3>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:col-span-2">
                  <h3 className="flex items-center gap-2 text-lg font-semibold text-white mb-6">
                    <BarChart3 className="w-5 h-5 text-amber-400" /> SWOT
                    Analysis
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm text-emerald-100/70">
                        {result.swot.strengths.map((i: string, idx: number) => (
                          <li key={idx}>{i}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-xl">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm text-amber-100/70">
                        {result.swot.threats.map((i: string, idx: number) => (
                          <li key={idx}>{i}</li>
                        ))}
                      </ul>
                    </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                  <h3 className="flex items-center gap-2 text-lg font-semibold text-white mb-4">
                    <Code2 className="w-5 h-5 text-indigo-400" /> Recommended
                    Tech Stack
                  </h3>
                  <div className="space-y-3">
                    {result.techStack.map((tech: any, idx: number) => (
                      <div
                        key={idx}
                        className="bg-black/50 border border-white/5 p-3 rounded-lg flex items-start gap-3"
                      >
